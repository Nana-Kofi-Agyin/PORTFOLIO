...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-[85vh] md:min-h-screen flex items-center px-[5%] md:px-[9%] pt-20 md:pt-24 pb-8 md:pb-12 relative overflow-hidden bg-[#0b0b1a]">
      ...
      <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-16 items-center w-full relative z-10">
        ...
        <motion.div
          ...
          className="space-y-4 md:space-y-6 lg:space-y-8 text-center lg:text-left flex flex-col items-center lg:items-start"
        >
          ...
          <motion.h1
            ...
            className="text-[2.5rem] sm:text-[3.5rem] md:text-[4.5rem] lg:text-[5.5rem] font-[800] leading-tight"
          >
            Hi, I'm{' '}
          ...
          <motion.div
            ...
            className="text-[1.4rem] sm:text-[1.6rem] md:text-[1.8rem] lg:text-[2rem] font-mono text-indigo-400"
          >
            &lt;{text}
          ...
          {/* Bio - Centered on mobile, more compact */}
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5 }}
            className="text-[1.25rem] sm:text-[1.35rem] md:text-[1.5rem] text-gray-400 leading-relaxed max-w-[600px] px-2 md:px-0"
          >
          ...
          >
            <a 
              ...
              className="min-w-[44px] min-h-[44px] w-12 h-12 md:w-14 md:h-14 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-indigo-600/20 hover:border-indigo-500/50 transition-all duration-300 active:scale-95"
              aria-label="GitHub"
            >
              <Github className="w-5 h-5 md:w-6 md:h-6 text-gray-300" />
            </a>
            <a 
              ...
              aria-label="LinkedIn"
            >
              <Linkedin className="w-5 h-5 md:w-6 md:h-6 text-gray-300" />
            </a>
            <a 
              ...
              aria-label="Twitter"
            >
              <Twitter className="w-5 h-5 md:w-6 md:h-6 text-gray-300" />
            </a>
          </motion.div>
        ...
        {/* Image Container - Mobile: Top (smaller), Desktop: Right column */}
        <motion.div
        ...
        >
          <div className="relative w-[220px] h-[280px] sm:w-[280px] sm:h-[350px] md:w-[360px] md:h-[450px] lg:w-[450px] lg:h-[550px]">
            {/* Glow effect */}
